...
export function detectLanguage(text: string): Locale | null {
	...
	const chineseMatches = (trimmedText.match(new RegExp(chineseRegex, 'g')) || []).length;

	// Check for Japanese-specific characters
	// Hiragana: \u3040-\u309f
	// Katakana: \u30a0-\u30ff
	const japaneseRegex = /[\u3040-\u309f\u30a0-\u30ff]/;
	const japaneseMatches = (trimmedText.match(new RegExp(japaneseRegex, 'g')) || []).length;

	// Check for German-specific words (case-insensitive)
	const germanWords = [
		'und', 'oder', 'aber', 'wenn', 'dann', 'ich', 'du', 'er', 'sie', 'es',
		'wir', 'ihr', 'sind', 'bin', 'bist', 'ist', 'haben', 'habe', 'hat',
		'werden', 'wird', 'kann', 'können', 'müssen', 'sollen', 'wollen',
		'der', 'die', 'das', 'den', 'dem', 'des', 'ein', 'eine', 'einer',
		'nicht', 'auch', 'nur', 'noch', 'schon', 'immer', 'viel', 'sehr',
		'guten', 'gute', 'guter', 'danke', 'bitte', 'ja', 'nein'
	];
